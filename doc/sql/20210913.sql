...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`basic-project` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `person`(`id`,`name`,`age`,`birthday`,`gender`,`address`,`summary`,`create_by`,`create_time`,`update_by`,`update_time`) values ('1258666571831767042','张三1',10,'2020-01-01',1,'山东临沂1','我厉害了1','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571844349953','张三2',11,'2020-01-02',1,'山东临沂2','我厉害了2','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571852738561','张三3',12,'2020-01-03',2,'山东临沂3','我厉害了3','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571873710081','张三4',13,'2020-01-04',0,'山东临沂4','我厉害了4','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571886292994','张三5',14,'2020-01-05',1,'山东临沂5','我厉害了5','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571894681602','张三6',15,'2020-01-06',0,'山东临沂6','我厉害了6','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571907264514','张三7',16,'2020-01-07',1,'山东临沂7','我厉害了7','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571915653122','张三8',17,'2020-01-08',0,'山东临沂8','我厉害了8','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571924041730','张三9',18,'2020-01-09',2,'山东临沂9','我厉害了9','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571940818945','张三10',19,'2020-01-10',1,'山东临沂10','我厉害了10','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571949207553','张三11',20,'2020-01-11',0,'山东临沂11','我厉害了11','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571961790466','张三12',21,'2020-01-12',2,'山东临沂12','我厉害了12','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571970179073','张三13',22,'2020-01-13',0,'山东临沂13','我厉害了13','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571982761985','张三14',23,'2020-01-14',1,'山东临沂14','我厉害了14','admin','2020-05-08 15:54:30',NULL,NULL),('1258666571995344897','张三15',24,'2020-01-16',2,'山东临沂15','我厉害了15','admin','2020-05-08 15:54:30',NULL,NULL),('1258670326111272962','张三1',10,'2020-01-01',1,'山东临沂1','我厉害了1','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326161604610','张三2',11,'2020-01-02',1,'山东临沂2','我厉害了2','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326182576129','张三3',12,'2020-01-03',2,'山东临沂3','我厉害了3','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326207741953','张三4',13,'2020-01-04',0,'山东临沂4','我厉害了4','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326224519170','张三5',14,'2020-01-05',1,'山东临沂5','我厉害了5','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326245490690','张三6',15,'2020-01-06',0,'山东临沂6','我厉害了6','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326279045121','张三7',16,'2020-01-07',1,'山东临沂7','我厉害了7','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326304210945','张三8',17,'2020-01-08',0,'山东临沂8','我厉害了8','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326329376770','张三9',18,'2020-01-09',2,'山东临沂9','我厉害了9','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326354542593','张三10',19,'2020-01-10',1,'山东临沂10','我厉害了10','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326362931202','张三11',20,'2020-01-11',0,'山东临沂11','我厉害了11','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326388097026','张三12',21,'2020-01-12',2,'山东临沂12','我厉害了12','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326421651458','张三13',22,'2020-01-13',0,'山东临沂13','我厉害了13','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326434234369','张三14',23,'2020-01-14',1,'山东临沂14','我厉害了14','admin','2020-05-08 16:09:25',NULL,NULL),('1258670326455205889','张三15',24,'2020-01-15',2,'山东临沂15','我厉害了15','admin','2020-05-08 16:09:25',NULL,NULL),('1377193036516208642','111',111,'2021-03-09',0,'11','111','admin','2021-03-31 17:36:22','admin','2021-03-31 17:36:22');
...
CREATE TABLE `sys_config` (
  ...
  `code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配置项编码',
  `value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配置项值',
  `model` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '配置模块编码',
...
insert  into `sys_config`(`id`,`code`,`value`,`model`,`create_by`,`create_time`,`update_by`,`update_time`) values ('1437246617392857089','sys_name','后台管理系统','basic','admin','2021-09-13 10:47:51','admin','2021-09-13 10:48:04'),('1437246617455771649','sys_title','测试后台管理','basic','admin','2021-09-13 10:47:51','admin','2021-09-13 10:48:04'),('1437246617455771650','login_content','','basic','admin','2021-09-13 10:47:51','admin','2021-09-13 10:48:04'),('1437246617455771651','login_title','','basic','admin','2021-09-13 10:47:51','admin','2021-09-13 10:48:04');
...
CREATE TABLE `sys_login_log` (
  ...
  `status` int DEFAULT '0' COMMENT '登录状态 1成功0失败',
...
insert  into `sys_login_log`(`id`,`username`,`login_ip`,`browser`,`os`,`status`,`login_time`,`msg`) values ('1435493358709841921','admin','0:0:0:0:0:0:0:1','Chrome 9','Windows 10',1,'2021-09-08 14:41:02','登录成功'),('1435497445769637890','admin','127.0.0.1','Chrome 9','Windows 10',1,'2021-09-08 14:57:16','登录成功'),('1436208227536896002','admin','0:0:0:0:0:0:0:1','Chrome 9','Windows 10',1,'2021-09-10 14:01:39','登录成功'),('1436221468430327810','admin','0:0:0:0:0:0:0:1','Chrome 9','Windows 10',1,'2021-09-10 14:54:16','登录成功'),('1436240144458080258','ceshi','0:0:0:0:0:0:0:1','Chrome 9','Windows 10',0,'2021-09-10 16:08:29','用户名密码不正确'),('1436240347848269825','admin','0:0:0:0:0:0:0:1','Chrome 9','Windows 10',1,'2021-09-10 16:09:18','登录成功'),('1437246548778237953','admin','0:0:0:0:0:0:0:1','Chrome 9','Windows 10',1,'2021-09-13 10:47:34','登录成功');
...
CREATE TABLE `sys_operate_log` (
  ...
  `type` int DEFAULT '0' COMMENT '业务类型0其他1新增2修改3删除',
  `method` varchar(100) DEFAULT NULL COMMENT '方法名称',
  `request_type` varchar(100) DEFAULT NULL COMMENT '请求类型',
  `oper_type` int DEFAULT '0' COMMENT '操作类型0其他1后台2移动端',
  ...
  `state` int DEFAULT '0' COMMENT '操作状态0正常1异常',
...
insert  into `sys_operate_log`(`id`,`name`,`type`,`method`,`request_type`,`oper_type`,`oper_user_id`,`oper_user_name`,`oper_user_account`,`oper_time`,`oper_url`,`oper_ip`,`oper_location`,`oper_param`,`result_param`,`state`,`error_msg`) values ('1435493401227501570','用户信息修改',2,'com.basic.controller.system.user.UserController.doUpdate()','POST',1,'1242327057416970241','超级管理员','admin','2021-09-08 14:41:12','/user/update','0:0:0:0:0:0:0:1','内网IP','{\r\n  \"id\" : [ \"1435083582674939906\" ],\r\n  \"nickname\" : [ \"测试\" ],\r\n  \"mobile\" : [ \"\" ],\r\n  \"email\" : [ \"\" ],\r\n  \"remark\" : [ \"\" ]\r\n}','{\r\n  \"success\" : true,\r\n  \"message\" : \"信息修改成功\",\r\n  \"code\" : 1000\r\n}',0,NULL),('1435508224937979906','用户信息修改',2,'com.basic.controller.system.user.UserController.doUpdate()','POST',1,'1242327057416970241','超级管理员','admin','2021-09-08 15:40:06','/user/update','127.0.0.1','内网IP','{\r\n  \"id\" : [ \"1435083582674939906\" ],\r\n  \"nickname\" : [ \"测试\" ],\r\n  \"mobile\" : [ \"18989898899\" ],\r\n  \"email\" : [ \"189@163.com\" ],\r\n  \"remark\" : [ \"测试用户\" ]\r\n}','{\r\n  \"success\" : true,\r\n  \"message\" : \"信息修改成功\",\r\n  \"code\" : 1000\r\n}',0,NULL);
...
CREATE TABLE `sys_organization` (
  ...
  `isdel` int DEFAULT '0' COMMENT '删除标志（0代表存在 1代表删除）',
...
insert  into `sys_role`(`id`,`name`,`code`,`comment`) values ('1339098556764524545','系统管理员','xitong','角色111'),('1339100639353901058','服务器管理员','fuwuqi','');
...
CREATE TABLE `sys_user` (
  `id` varchar(40) NOT NULL COMMENT '主键',
  `username` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登录账号',
  `password` varchar(40) DEFAULT NULL COMMENT '密码',
  `password_level` int DEFAULT '0' COMMENT '密码强度0初始 1很弱 2弱 3安全 4很安全',
  ...
  `status` int DEFAULT '1' COMMENT '用户状态，0禁用，1启用',
  `fail_num` int DEFAULT '0' COMMENT '连续登录失败次数',
  `last_fail_time` datetime DEFAULT NULL COMMENT '最近登录失败时间',
  `last_login_time` datetime DEFAULT NULL COMMENT '最近登录时间',
  `last_login_ip` varchar(100) DEFAULT NULL COMMENT '最近登录ip',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
...
insert  into `sys_user`(`id`,`username`,`password`,`password_level`,`salt`,`nickname`,`email`,`mobile`,`icon`,`status`,`fail_num`,`last_fail_time`,`last_login_time`,`last_login_ip`,`create_time`,`create_by`,`update_time`,`update_by`,`remark`) values ('1242327057416970241','admin','9f8e6fbb5b4149b4450bcbdc315ef375',0,'ers3tjhdnz','超级管理员','admin2@qq.com','18858868888',NULL,1,0,NULL,'2021-09-13 10:47:34','0:0:0:0:0:0:0:1','2020-03-24 13:47:06',NULL,'2021-09-13 10:47:34','admin',NULL),('1435083582674939906','ceshi','58a03cd3ab2ceac6c1413cb3f809e641',0,'qk5281telt','测试','189@163.com','18989898899',NULL,1,1,'2021-09-10 16:08:29','2021-09-07 17:26:01','0:0:0:0:0:0:0:1','2021-09-07 11:32:43','admin','2021-09-10 16:08:29','admin','测试用户');
...
insert  into `sys_user_role`(`user_id`,`role_id`) values ('1339051163721404418','1339100639353901058'),('1242327057416970241','1339098556764524545'),('1435083582674939906','1339100639353901058'),('1435083582674939906','1339098556764524545');
