...
<div class="wrapper wrapper-content animated fadeInRight ibox-content">
    <form class="form-horizontal m" id="form-role-update">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input class="form-control required" type="text" name="name" id="name" data-msg="请输入角色名称"  placeholder="请输入角色名称" value="${role.name}">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label is-required">角色编码：</label>
            <div class="col-sm-8">
                <input class="form-control required" type="text" name="code" id="code" data-msg="请输入角色编码"  placeholder="请输入角色编码" value="${role.code}">
            </div>
        </div>
        <div class="form-group">
