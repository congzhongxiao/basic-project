...
public class UploadConstant {
    ...
    public static final String UPLOAD_FOLDER_COMPRESS = "/compresses";//压缩包文件路径
    public static final String UPLOAD_FOLDER_UEDITOR = "/ueditor";//压缩包文件路径
    public static final String UPLOAD_FOLDER_THUMBNAIL = "/thumbnail";//缩略图文件路径
